...
Results: Tigers favoured roughly 60% in sim
Angels win 1-4 in the ninth
...
myDiamond = Diamond('Angels_Stadium')
...
for game in range(numGames):
    ...
    if playOneGame(Tigers,Angels, myDiamond) == 'Tigers':
...
labels = ['Tigers','Angels']

sizes = [(100/numGames)*winners.count(0), (100/numGames)*winners.count(1)]

pylab.pie(sizes, labels=labels, autopct='%1.2f%%', shadow=True)
pylab.axis('equal')
pylab.show()
