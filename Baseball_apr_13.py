...
class Team(object):
    ...
    def __str__(self):
        ...
        print('\n----------')#TODO:
        print('Batters on the ' + self.city +' '+ self.name + ':')#TODO:
...
class Diamond(object):
    ...
    def baseHit(self, team, player):
        ...
        if len(self.onBase) == 0:
            ...
            self.fBase = '▣'
            print(self.onBase[0].getPlayerName() + ' is on first!')#TODO:
            ...
            print('RBI for ' + team.roster[player].getPlayerName() + '!')#TODO:
            print(self.onBase[0].getPlayerName() + 'scores.')
            self.onBase[2] = self.onBase[1]
            self.onBase[1] = self.onBase[0]
            self.onBase[0] = team.roster[player]#TODO:
            print('Bases loaded. \n' + self.onBase[0].getPlayerName() + ' on first, \n' + self.onBase[1].getPlayerName() + ' on second, \n' + self.onBase[2].getPlayerName() + ' on third.')
